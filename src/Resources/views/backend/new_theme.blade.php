                    ...
                    <form class="m-t-20">
                        <div class="form-group">
                            <input type="text" class="form-control" id="nametext2" aria-describedby="name"
                                   placeholder="Name">
                            <small id="name1" class="badge badge-default badge-info form-text text-white float-left">Helper
                                Text</small>
                        </div>
                    </form>
                </div>
                    ...
                    <form class="m-t-20">
                        <div class="form-group m-b-0">
                            ...
                            <p class="text-center m-b-0">
                                <small id="name45" class="badge badge-default badge-warning form-text text-white">Helper
                                    Text</small>
                            </p>
                        </div>
                    </form>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-20">
                        <input type="text" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom"
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-20">
                        <input type="text" data-toggle="tooltip" data-placement="right" title="Tooltip on right"
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-20">
                        <input type="text" data-toggle="tooltip" data-placement="left" title="Tooltip on left"
