...
(function ($, window, document) {
    ...
    function Wickedpicker(element, options) {
        ...
        this.minutesInterval = this.options.minutesInterval;
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        _setOptions: function (options) {
            if(options.minutesInterval!== undefined){
                this.options.minutesInterval = options.minutesInterval;
                this.setMinutes(0);
            }
        }
    });
    ...
    $.fn[pluginName] = function (options, index, parameter) {
        console.log(options, index, parameter);
        if (!$.isFunction(Wickedpicker.prototype['_' + options])) {
            ...
            return $.data($(this)[0], 'plugin_' + pluginName)['_' + options](parameter);
        }
